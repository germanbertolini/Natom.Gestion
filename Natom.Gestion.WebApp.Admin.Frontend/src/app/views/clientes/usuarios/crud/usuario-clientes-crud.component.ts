...
@Component({
  selector: 'app-usuario-clientes-crud',
  styleUrls: ['./usuario-clientes-crud.component.css'],
  templateUrl: './usuario-clientes-crud.component.html'
})

export class UsuarioClientesCrudComponent implements OnInit {
  permisos: PermisoDTO[];
