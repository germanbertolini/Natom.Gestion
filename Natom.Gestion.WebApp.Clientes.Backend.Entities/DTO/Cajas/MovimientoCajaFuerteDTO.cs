...
namespace Natom.Gestion.WebApp.Clientes.Backend.Entities.DTO.Cajas
{
    public class MovimientoCajaFuerteDTO
    {
        ...
        {
            EncryptedId = EncryptionService.Encrypt<MovimientoCajaFuerte>(entity.MovimientoCajaFuerteId);
