...
('WebApp.Admin.NewDeployment.SqlUserName', 'german', 'Credenciales SQL: Nombre del usuario'),
('WebApp.Admin.NewDeployment.SqlPassword', 'German123', 'Credenciales SQL: Password del usuario'),
('WebApp.Clientes.URL','http://localhost:4201','URL de acceso a la aplicación de Clientes'),
('WebApp.Clientes.Backend.URL','http://localhost:23620','URL del Backend de la aplicación de Clientes'),
